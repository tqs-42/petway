...
public class CartServiceTest {
    ...
    @Test
    void testWhenValidEmailAndValidproductId_thenRequestProductsShouldBeFound() {
    ...
    @Test
    void testWhenInvalidEmailAndValidproductId_thenReturnEmpty() {
        Optional<RequestProducts> fromDb = service.getProductAmout("b", 1L);

        assertEquals(fromDb, Optional.empty());
    ...
    @Test
    void testWhenValidEmailAndInvalidproductId_thenReturnEmpty() {
        Optional<RequestProducts> fromDb = service.getProductAmout("eva@ua.pt", 20L);
    ...
    @Test
    void testWhenInvalidEmailAndInvalidproductId_thenReturnEmpty() {
        Optional<RequestProducts> fromDb = service.getProductAmout("b", 20L);
    ...
    void testWhenProductAmountInvalidEmailValidproductId_thenReturnRequestProducts() {
        Optional<RequestProducts> fromDb = service.putProductAmout("b", 1, 10);
    ...
    void testWhenProductAmountValidEmailInvalidproductId_thenReturnRequestProducts() {
        Optional<RequestProducts> fromDb = service.putProductAmout("eva@ua.pt", 100, 10);
    ...
    void testWhenProductAmountInvalidEmailInvalidproductId_thenReturnRequestProducts() {
        Optional<RequestProducts> fromDb = service.putProductAmout("b", 100, 10);
